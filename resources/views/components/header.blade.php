        ...
        <nav class="flex items-center h-full">
            ...
            <div class="w-auto flex items-center space-x-4 md:space-x-10 flex-shrink-0">
                ...
                <button id="open-cart-button" class="relative text-gray-200 hover:text-green-400">
                    ...
                    <span id="cart-item-count" class="absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full h-5 w-5 hidden" style="display: none; align-items: center; justify-content: center;">0</span>
                </button>
