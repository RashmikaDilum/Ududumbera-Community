    ...
    <div class="container mx-auto h-full relative">
        ...
        <nav class="flex items-center h-full">
            ...
            <div class="space-x-6 md:flex hidden flex-shrink-0">
                ...
                <a href="{{ url('/register') }}" class="{{ request()->is('auth.register') ? 'text-green-400 font-bold border-green-400' : 'text-gray-200 font-medium border-transparent' }} pb-1 border-b-2 hover:text-green-400 transition duration-300">Register</a>
            </div>
